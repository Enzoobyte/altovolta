...
export function CartLink() {
  ...
  return (
    <Link
      href="/carrito"
      className="relative flex h-10 items-center gap-2 rounded-full border border-zinc-700 px-4 text-sm font-semibold text-white transition hover:border-red-600 hover:text-red-500"
    >
